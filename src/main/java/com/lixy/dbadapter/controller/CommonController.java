...
public class CommonController {
     ...
     * @return
     */
    @ApiOperation(value = "获取目标库的数据库分页列表", notes = "获取目标库的数据库分页列表", response = ResponseResult.class)
    @PostMapping(value = "/findTablePage")
    public ResponseResult findTablePage(@RequestBody TablePageQueryVo pageQueryVo) {
        ResponseResult result = new ResponseResult();

        result.setData(commonService.findTablePage(pageQueryVo));
